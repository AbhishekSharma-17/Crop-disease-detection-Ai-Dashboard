        ...
        def show_homepage():
            ...
            with col1:
                st.markdown(
                            ...
                            <div style="background: linear-gradient(-20deg, #d558c8 0%, #24d292 100%); padding: 20px; border-radius: 10px; box-shadow: 2px 2px 5px rgba(0,0,0,0.1);margin-top:50px; width:680px; padding:20px">
                                <h3>About Us</h3>
                                <p style="text-align:justify";>GreenSenseAI is a cutting-edge AI assistant specialized in agriculture. Our mission is to provide insightful data analysis and help farmers make informed decisions.</p>
 ...
 border-radius: 10px; text-align: center;">
        ...
        def predict_crop(
            ...
            if (
                ...
                (temperature >= 16 and temperature <= 30)
                and (humidity >= 50 and humidity <= 70)
                and (moisture >= 11 and moisture <= 13)
            ):
                return "Soyabean"
            elif (
